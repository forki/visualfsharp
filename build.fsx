...
let binDir targetPlatform = buildConfig + "/" + targetPlatform + "/bin/"
let net40BinDir = binDir "net40"
...
Target "Clean" (fun _ ->
    CleanDirs [ buildLogsDir; testLogsDir; testToolDir; protoBinDir; "./" @@ buildConfig ]
)
...
Target "RunCoreUnitTests" (fun _ ->
    let runTests targetPlatform =
        [binDir targetPlatform @@ "FSharp.Core.Unittests.dll"]
        |> NUnit (fun p ->
            { p with
